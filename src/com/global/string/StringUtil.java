 ...
 * <p/>
 * <p>
 * Originally from <a href="http://jakarta.apache.org/turbine/">Turbine</a>, the
 * GenerationJavaCore library and Velocity. Later a lots methods from
 * commons-lang StringUtils got added too. Gradually smaller additions and fixes
...
public class StringUtil {
	...
	// "(\\+86|86|0086)?(13[0-9]|15[0-35-9]|14[57]|18[02356789])\\d{8}";
	...
	public static boolean canCallC2P(String number) {
		...
		return Pattern.matches(MOBILE_REGEX, number)
				| Pattern.matches(PSTN_REGEX, number) ? true : number
				.startsWith("00") | number.startsWith("+");
	}
	...
	public static int checkStrong(String password) {
		...
		// 数字、大写字母�?小写字母只有�?��，密码强度低（只有一种特殊字符也是密码强度低�?
	...
	public static String getXmlValue(String xml, String tag) {
		...
		CLog.e("No such tag : " + tag + " was found!");
		return null;
	}
	...
	public static String byteToString(byte[] b) {
		...
		return retval.substring(10, len - 4);
	}
	 ...
	 * <p/>
	 * <p>
	 * <strong>Note:</strong> In future releases, this method will no longer
	 * trim the input string such that it works complementary to
	 * {@link #isNotEmpty(String)}. Code that wants to test for whitespace-only
	 * strings should be migrated to use {@link #isBlank(String)} instead.
	 * </p>
	 * 
	 * @param str
	 *            the String to check
	 ...
	 * <p/>
	 * <p>
	 * <code>Nulls</code> are handled without exceptions. Two <code>null</code>
	 ...
	 * @throws NullPointerException
	 *             if any of searchStrs[i] is <code>null</code>
	 */
	 ...
	 * <p/>
	 * <p>
	 * If <code>n</code> characters are not available, or the String is
	 ...
	 * <p/>
	 * <p>
	 * If <code>n</code> characters are not available, the remainder of the
	 ...
	 * <p/>
	 * <p>
	 * The separator is not included in the returned String array. The maximum
	 * number of splits to perfom can be controlled. A <code>null</code>
	 ...
	 * @param max
	 *            The maximum number of elements to parse. The rest of the
	 *            string to parse will be contained in the last array element. A
	 ...
	 * <code>max</code> values of the search char.
	 * </p>
	 * <p/>
	 * <p>
	 * A <code>null</code> reference passed to this method is a no-op.
	 ...
	 * @throws NullPointerException
	 *             if text or overlay is <code>null</code>
	 */
	 ...
	 * @return String containing centered String
	 * @throws NullPointerException
	 *             if str or delim is <code>null</code>
	 ...
	 * <p/>
	 * <p>
	 * That is, convert the first character into lower-case. <code>null</code>
	 * is returned as <code>null</code>.
	 * </p>
	 * 
	 * @param str
	 ...
	 * <p/>
	 * <p>
	 * That is, convert the first character into title-case. <code>null</code>
	 * is returned as <code>null</code>.
	 * </p>
	 * 
	 * @param str
	 ...
	 * <p/>
	 * <p>
	 * Properly looks after making sure the start of words are Titlecase and not
	 * Uppercase.
	 * </p>
	 * <p/>
	 * <p>
	...
	/**
	 * <p>
	 * Returns either the passed in <code>Object</code> as a String, or, if the
	 * <code>Object</code> is <code>null</code> , an empty String.
	 * </p>
	 * 
	 * @param obj
	 *            the Object to check
	 ...
	 * <p>
	 * Returns either the passed in <code>Object</code> as a String, or, if the
	 * <code>Object</code> is <code>null</code> , a passed in default String.
	 * </p>
	 * 
	 * @param obj
	 *            the Object to check
	 ...
	 * Specifically:
	 * <p/>
	 * If str is less than max characters long, return it. Else abbreviate it to
	 * (substring(str, 0, max-3) + "..."). If maxWidth is less than 3, throw an
	 ...
	 * the ellipses, but it will appear somewhere in the result. In no case will
	 * it return a string of length greater than maxWidth.
	 * 
	 * @param offset
	...
	/**
	 * Fill all 'variables' in the given text with the values from the map. Any
	 * text looking like '${key}' will get replaced by the value stored in the
	 * namespace map under the 'key'.
	 * 
	 * @param text
	 * @param namespace
	...
	public static String interpolate(String text, Map namespace) {
		...
		while (keys.hasNext()) {
			...
			if (obj == null) {
				throw new NullPointerException("The value of the key '" + key
						+ "' is null.");
			}
	...
	/**
	 * This is basically the inverse of {@link #addAndDeHump(String)}. It will
	 * remove the 'replaceThis' parameter and uppercase the next character
	 * afterwards.
	 * 
	 * <pre>
	...
	/**
	 * Convert the first character of the given String to uppercase. This method
	 * will <i>not</i> trim of spaces!
	 * <p>
	...
	public static String capitalizeFirstLetter(String data) {
		char firstLetter = Character
				.toTitleCase(data.substring(0, 1).charAt(0));
	...
	/**
	 * Convert the first character of the given String to lowercase. This method
	 * will <i>not</i> trim of spaces!
	 * <p>
	 * <b>Attention:</b> this method will currently throw a
	 * <code>IndexOutOfBoundsException</code> for empty strings!
	 ...
	 * 
	 * @param data
	 *            the String to get it's first character lower-cased.
	...
	public static String lowercaseFirstLetter(String data) {
		char firstLetter = Character
				.toLowerCase(data.substring(0, 1).charAt(0));
	 ...
	 */
	public static String quoteAndEscape(String source, char quoteChar,
			final char[] escapedChars, char escapeChar, boolean force) {
		return quoteAndEscape(source, quoteChar, escapedChars,
				new char[] { ' ' }, escapeChar, force);
	}
	 ...
	 */
	public static String quoteAndEscape(String source, char quoteChar,
			final char[] escapedChars, final char[] quotingTriggers,
	 ...
	 * @since 1.5.1
	 */
	public static String escape(String source, final char[] escapedChars,
			char escapeChar) {
		if (source == null) {
			return null;
		}
	 ...
	 *            a not null String
	 * @param ls
	 *            the wanted line separator ("\n" on UNIX), if <code>null</code>
	 *            using the System line separator.
	 * @return a String that contains only System line separators.
	 * @throws IllegalArgumentException
	 *             if ls is not '\n', '\r' and '\r\n' characters.
	 * @since 1.5.7
	...
	public static String unifyLineSeparators(String s, String ls) {
		...
		if (!(ls.equals("\n") || ls.equals("\r") || ls.equals("\r\n"))) {
			throw new IllegalArgumentException(
					"Requested line separator is invalid.");
		}
	...
	public static int parseInt(String temp, int defaultNum) {
		if (temp == null) {
			return defaultNum;
		}
		try {
