...
public class ZipUtil {
	 ...
	 * @throws Exception
	 */
	public static void ZipFolder(File[] srcFile, String zipFileString,
			FilenameFilter filter) throws Exception {
	...
	private static void ZipFiles(String folderString, String fileString,
			java.util.zip.ZipOutputStream zipOutputSteam, FilenameFilter filter)
			throws Exception {
			...
			if (fileList != null) {
				for (int i = 0; i < fileList.length; i++) {
					ZipFiles(folderString, fileString + java.io.File.separator
							+ fileList[i], zipOutputSteam, filter);
				}// end of for
			}
		}// end of if
